...
## 📌 Overview
This project is created for the *Database* course (Fall 2025/2026), Faculty of Computers and Data Science, Alexandria University.  
...
- Map the model to a complete relational schema (PKs, FKs, constraints).
